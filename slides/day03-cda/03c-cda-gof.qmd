...
Medel had the hypothesis that the four different types occur in proportions of 9:3:3:1, that is
$$
...
1. If `response` is a factor, then list the proportions of the levels in order of `levels(response)`
